...
Alternative SoftwareSerial in Arduino. CustomSoftwareSerial library allow to configure and custom parity bit, stop bits and data's bit to make the lib more useful. The library bases on Arduino's SoftwareSerial. Some standard we tried to cover in this library:
